...
def Pago():
    ...
    peticion = requests.post("http://154.38.171.54:5006/pago", data=json.dumps(newPago))
    res = peticion.json()
...
def Empleado():
    ...
    peticion = requests.post("http://154.38.171.54:5003/empleado", data=json.dumps(newEmpleado))
    res = peticion.json()
...
def Oficina():
    ...
    peticion = requests.post("http://154.38.171.54:5005/oficina", data=json.dumps(newOficina))
    res = peticion.json()
...
def Pedido():
    ...
    peticion = requests.post("http://154.38.171.54:5007/pedido", data=json.dumps(newPedido))
    res = peticion.json()
...
def Producto():
    ...
    peticion = requests.post("http://154.38.171.54:5008/producto", data=json.dumps(newProducto))
    res = peticion.json()
    res["Mensaje"] = "Producto Guardado"
    return [res]
...
def DetallePed():
    ...
    peticion = requests.post("http://154.38.171.54:5002/detalle", data=json.dumps(newDetallePed))
    res = peticion.json()
